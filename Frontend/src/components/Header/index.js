        ...
        <div>
            {isAdmin ?
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"red" }} expand="lg" bg="light" variant="light">
                    <Navbar.Brand><Link to='/admin/dashboard' style={{ textDecoration: 'none' }}>SHOP-Mart</Link></Navbar.Brand>
                ...
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"#ADD8E6" }} expand="lg" >
                    <Navbar.Brand><Link to='/' style={{ textDecoration: 'none' }}>SHOP-SMART</Link></Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarSupportedContent" />
                    <Navbar.Collapse id="navbarSupportedContent">
                        <Nav className="mr-auto">
